 ...
 */
class ImportActors implements DataPatchInterface
{
    /**
     * Constructor.
     *
    ...
    public function apply(): void
    {
        ...
        $output->writeln('<info>Start Import Actors</info>');
        $start = microtime(true);
        $this->dataHelper->importData(
            'actor',
            $this->fileManager->getParsedFixtureData('Ghost_Setup::Setup/fixtures/actors.csv')
        );
